...
| JIRA-UI-04 | Verify the guide by running the instructions and capturing screenshots | Medium | QA | JIRA-UI-03 | [F-0001](specs/F-0001-antigravity-ui-automation-guide.md) | SWE-2 | In Progress |
...
| JIRA-UI-06 | Record and provide the walkthrough demo | Medium | QA/Demo | JIRA-UI-05 | [F-0001](specs/F-0001-antigravity-ui-automation-guide.md) | SWE-2 | In Progress |
